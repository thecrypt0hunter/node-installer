...
COINRUNCMD="sudo dotnet ./oxd.dll ${NETWORK} -datadir=/home/${NODE_USER}/.${FORK}chain -maxblkmem=2 -txindex=1 -hdwallet #-stake -walletname=\${STAKINGNAME} -walletpassword=\${STAKINGPASSWORD}"
